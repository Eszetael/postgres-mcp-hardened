...
| MCP09 | Shadow MCP Servers | ◻ N/A | An organizational governance concern (unmanaged instances), not a property of a single server. Mitigated indirectly by shipping one versioned, signed artifact. |
